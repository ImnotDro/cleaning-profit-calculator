...
const APP_CONFIG = Object.freeze({
  ...
  commercialOffer: {
    ...
    purchaseUrl: "https://imnotdro.gumroad.com/l/cleaning-business-pricing-toolkit",
  },
  storage: {
...
const TRANSLATIONS = Object.freeze({
  en: {
    ...
    resultOfferPrompt: "Want the full pricing system?",
    resultOfferLink: "Get the Cleaning Business Pricing Toolkit →",
    ...
    offerHeadline: "Ready to build a complete pricing system?",
    offerDescription: "Get the Cleaning Business Pricing Toolkit and turn your real costs into consistent, profitable quotes.",
    offerIncludes: "What the toolkit includes",
    offerFeatureWorkbook: "Advanced Excel pricing workbook",
    offerFeatureOverheadSetup: "Business overhead setup",
    offerFeatureJobCalculator: "Job pricing calculator",
    offerFeatureBreakEven: "Break-even & profit margin calculator",
    offerFeatureServiceMenu: "Service menu planner",
    offerFeatureQuoteBuilder: "Client quote builder",
    offerFeatureMonthlyPlanner: "Monthly profit goal planner",
    offerFeatureQuickStart: "Quick-start PDF guide",
    offerDelivery: "Instant digital download",
    offerPrice: "{price} Launch Price",
    offerCta: "Get the Pricing Toolkit — {price}",
  ...
  es: {
    ...
    resultOfferPrompt: "¿Quieres el sistema de precios completo?",
    resultOfferLink: "Obtén el Cleaning Business Pricing Toolkit →",
    ...
    offerHeadline: "¿Listo para crear un sistema de precios completo?",
    offerDescription: "Obtén el Cleaning Business Pricing Toolkit y convierte tus costos reales en cotizaciones consistentes y rentables.",
    offerIncludes: "Qué incluye el toolkit",
    offerFeatureWorkbook: "Libro de Excel avanzado para calcular precios",
    offerFeatureOverheadSetup: "Configuración de gastos fijos del negocio",
    offerFeatureJobCalculator: "Calculadora de precios por trabajo",
    offerFeatureBreakEven: "Calculadora de punto de equilibrio y margen de utilidad",
    offerFeatureServiceMenu: "Planificador del menú de servicios",
    offerFeatureQuoteBuilder: "Generador de cotizaciones para clientes",
    offerFeatureMonthlyPlanner: "Planificador de metas mensuales de utilidad",
    offerFeatureQuickStart: "Guía PDF de inicio rápido",
    offerDelivery: "Descarga digital inmediata",
    offerPrice: "Precio de lanzamiento: {price}",
    offerCta: "Obtener el Pricing Toolkit — {price}",
...
function renderCommercialOffer() {
  ...
  setText("purchaseCtaLabel", t("offerCta", { price: formattedPrice }));
